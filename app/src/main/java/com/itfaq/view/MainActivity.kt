...
import com.itfaq.R
import com.itfaq.databinding.ActivityMainBinding
import com.itfaq.helper.EndPoints
import com.itfaq.helper.Resource
import com.itfaq.helper.Utility
import com.itfaq.model.Rates
import com.itfaq.viewmodel.MainViewModel
    ...
    private fun getAllCountries(): ArrayList<String> {
        ...
        for (locale in locales) {
            ...
            if (country.trim { it <= ' ' }.isNotEmpty() && !countries.contains(country)) {
                ...
                }else if (countries.contains("Australia")){
                    countries.add(country)
                }
            }
